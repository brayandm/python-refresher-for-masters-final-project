...
zones = ReplyKeyboardMarkup([["Zone 1", "Zone 2", "Zone 3", "Zone 4", "Zone 5"]])

async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await context.bot.send_message(chat_id=update.effective_chat.id, text="I'm a bot, please talk to me!", reply_markup=menu)

async def predict(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await context.bot.send_message(chat_id=update.effective_chat.id, text="Select the zone", reply_markup=zones)
